...
const App = () => {
  ...
  return (
    <div className='container'>
      ...
      <form>
        <div className='row'>
          <textarea rows="4" placeholder='Enter text' value={text} onChange={e=> setText(e.target.value)}/>
          <div className='voices-icons'>
            ...
            <i className={`fa-solid fa-volume-high ${isSpeaking}`} onClick={handlespeech}></i>
          </div>
        </div>
      </form>
      {
